...
// class EditAllBillForm extends React.Component {
//     constructor(props) {
//         super(props);
...
//                 <form className='modal2-form' onSubmit={this.handleSubmit}>
//                     <span className='modal2-close js-modal2-close'></span>
...
//                     </div>
//                 </form>
//                 <div onClick={this.handleClick} className='modal2-screen js-modal2-close'></div>
//             </div>
//         )
//     }
// }
...
// export default EditAllBillForm